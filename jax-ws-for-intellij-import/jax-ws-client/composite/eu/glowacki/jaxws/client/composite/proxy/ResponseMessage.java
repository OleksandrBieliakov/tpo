 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="result" type="{http://glowacki.eu/composite}PersonModel" maxOccurs="unbounded" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class ResponseMessage {
    ...
    protected List<PersonModel> result;
    ...
    public List<PersonModel> getResult() {
        if (result == null) {
            result = new ArrayList<PersonModel>();
        }
        return this.result;
    }
